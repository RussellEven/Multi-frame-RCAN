...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/dataset/tianchi_dataset',
...
parser.add_argument('--offset_val', type=int, default=15000,
...
parser.add_argument('--n_colors', type=int, default=15,
...
# Log specifications
parser.add_argument('--save', type=str, default='test_save',
...
# options for test
parser.add_argument('--testpath', type=str, default='/home/dataset/tianchi_dataset',
